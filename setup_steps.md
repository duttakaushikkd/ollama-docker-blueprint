...
```
   We map port 11434 and use a persistent volume so our models aren't wiped when
the container stops.
   docker run -d -v ollama_storage:/root/.ollama -p 11434:11434 --name ollama
ollama/ollama
   (Tip: If you have an NVIDIA GPU, make sure to install the NVIDIA Container
Toolkit and pass the --gpus=all flag for lightning-fast speeds!)
```
...
3. Turn off your Wi-Fi and Code!
   ...
   You can now point your Python, Node.js, or LangChain code directly to your
localhost endpoint.
